...
def get_config() -> ConfigResponse:
    ...
    return ConfigResponse(
        ...
        RETROARCH_ENABLED=cfg.RETROARCH_ENABLED,
        RETROARCH_MAX_SESSIONS=cfg.RETROARCH_MAX_SESSIONS,
        RETROARCH_CORES_PATH=cfg.RETROARCH_CORES_PATH,
        RETROARCH_PLATFORM_CORES=cfg.RETROARCH_PLATFORM_CORES,
